...
def main():
    ...
    features = {'Age' : age, 'Sex' : sex, 'Chest pain type' : chest_pain_type, 'BP' : bp, 'Cholesterol' : cholesterol, 'FBS over 120' : fbs, 'EKG results' : ekg_result, 'Max HR' : max_hr, 'Exercise angina' : exercise_angina, 
